...
public class Student {
	...
	//set 메서드(setter) => 필드데이터에 값을 저장하기위한 메서드
	...
	public void displayMyInfo() {
		...
		System.out.println("국어 : " + enScore);
		System.out.println("국어 : " + mathScore);
		System.out.println("국어 : " + getTotal());
		System.out.println("국어 : " + getAvg());
		
		if(checkPassIsTrue()) {
			System.out.println("으로 시험에 합격하셨습니다");
		}else {
			System.out.println("으로 시험에 불합격하셨습니다.");
		}
